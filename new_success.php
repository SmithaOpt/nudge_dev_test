        ...
        <div class="panel-group" id="accordion"> 
          ...
          <div class="panel panel-default" id="panel1">
            <div class="panel-heading" id="panel3heading" style="color: #ffce00;background-color: #333;">
              <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseThree" class="" aria-expanded="true">Payment Success</a></h4>
            </div>
                ...
                <div class="row">
                  <div class="col-md-11">
                   <div class="alert alert-success fade in alert-dismissable" style="margin-top:18px;">
                    ...
                    <form id="payment_form" name="juspayment_form">
                      <div class="form-group">
                        <label>Please Update Your PAN Number</label>
                        <input type="text" class="form-control" name="pan_number" id="pan_number" placeholder="Pan Number" value="">
                      </div>
                      <div class="form-group">
                        <input type="submit" class="btn custom-btn" value="Update">
                      </div>
                    </form>
                  </div>
                </div>
